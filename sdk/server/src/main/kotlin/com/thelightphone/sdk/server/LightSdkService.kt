    ...
    private fun handleRequest(
        ...
        when (allMethods[methodId]) {
            ...
            LightServiceMethod.RegisterMediaSession -> {
                val request = LightServiceMethod.RegisterMediaSession.decodeRequest(payload!!)
                LightSdkServer.onMediaSessionRegistered(request.packageName, request.active)
                LightResult.Success(
                    LightServiceMethod.RegisterMediaSession.encodeResponse(Unit)
                )
            }
